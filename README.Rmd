...
pmin.sw.LeukSurv.wbc<-p.min(pv=sw.LeukSurv.wbc);pmin.sw.LeukSurv.wbc
pmin.sf.LeukSurv.wbc<-p.min(pv=sf.LeukSurv.wbc);pmin.sf.LeukSurv.wbc
pmin.aov.lp.LeukSurv.wbc<-p.min(pv=anov.LeukSurv.lp.wbc);pmin.aov.lp.LeukSurv.wbc
pmin.aov.wbc.LeukSurv<-p.min(pv=anov.LeukSurv.wbc);pmin.aov.wbc.LeukSurv

pmin.sw.LeukSurv.lwbc<-p.min(pv=sw.LeukSurv.lwbc);pmin.sw.LeukSurv.lwbc
pmin.sf.LeukSurv.lwbc<-p.min(pv=sf.LeukSurv.lwbc);pmin.sf.LeukSurv.lwbc
pmin.aov.lp.LeukSurv.lwbc<-p.min(pv=anov.LeukSurv.lp.lwbc);pmin.aov.lp.LeukSurv.lwbc
pmin.aov.lwbc.LeukSurv<-p.min(pv=anov.LeukSurv.lwbc);pmin.aov.lwbc.LeukSurv
