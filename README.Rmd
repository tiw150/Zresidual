...
par(mfrow = c(1,2))
plot.Martg.resid(martg.LeukSurv.wbc,X="wbc",main.title = "Martingale Residual Plot of wbc Model")
plot.Martg.resid(martg.LeukSurv.logwbc,X="logwbc",main.title = "Martingale Residual Plot of lwbc Model")
