...
```{r}
par(mfrow = c(2,2),mar=c(4,4,1.5,2))
plot.zresid(Zresid.LeukSurv.wbc,X="wbc",
            xlab="wbc",main.title = "Z-residual Scatterplot of wbc model")
plot.zresid(Zresid.LeukSurv.logwbc,X="logwbc",
            xlab="log(wbc)",main.title = "Z-residual Scatterplot of lwbc model")
boxplot.zresid(Zresid.LeukSurv.wbc,X="wbc",main.title = "Z-residual Boxplot of wbc model",xlab="wbc")
boxplot.zresid(Zresid.LeukSurv.logwbc,X="logwbc",main.title = "Z-residual Boxplot of wbc model", xlab="log(wbc)")
...
boxplot.zresid(Zresid.LeukSurv.wbc, X ="sex1", xlab="sex",main.title = "Z-residual Boxplot of wbc model")
boxplot.zresid(Zresid.LeukSurv.logwbc,X ="sex1", xlab="sex",main.title = "Z-residual Boxplot of lwbc model")
...
```{r}
anov.test.zresid(Zresid.LeukSurv.wbc, k.anova=10)
anov.test.zresid(Zresid.LeukSurv.logwbc, k.anova=10)

bartlett.test.zresid(Zresid.LeukSurv.wbc, k.bl=10)
bartlett.test.zresid(Zresid.LeukSurv.logwbc, k.bl=10)

anov.test.zresid(Zresid.LeukSurv.wbc,X="wbc", k.anova=10)
anov.test.zresid(Zresid.LeukSurv.logwbc,X="logwbc", k.anova=10)
...
anov.LeukSurv.lp.wbc<-anov.test.zresid(Zresid.LeukSurv.wbc, k.anova=10)
anov.LeukSurv.lp.lwbc<-anov.test.zresid(Zresid.LeukSurv.logwbc, k.anova=10)

anov.LeukSurv.wbc<-anov.test.zresid(Zresid.LeukSurv.wbc,X="wbc", k.anova=10)
anov.LeukSurv.lwbc<-anov.test.zresid(Zresid.LeukSurv.logwbc,X="logwbc", k.anova=10)
...
pmin.aov.lp.LeukSurv.wbc<-pvalue.min(pv=anov.LeukSurv.lp.wbc);pmin.aov.lp.LeukSurv.wbc
pmin.aov.wbc.LeukSurv<-pvalue.min(pv=anov.LeukSurv.wbc);pmin.aov.wbc.LeukSurv
...
pmin.aov.lp.LeukSurv.lwbc<-pvalue.min(pv=anov.LeukSurv.lp.lwbc);pmin.aov.lp.LeukSurv.lwbc
pmin.aov.lwbc.LeukSurv<-pvalue.min(pv=anov.LeukSurv.lwbc);pmin.aov.lwbc.LeukSurv
...
par(mfrow = c(1,2))
plot.zresid(martg.LeukSurv.wbc,X="wbc",main.title = "Martingale Residual Plot of wbc Model",ylab="Martingale")
plot.zresid(martg.LeukSurv.logwbc,X="logwbc",main.title = "Martingale Residual Plot of lwbc Model",ylab="Martingale")
...
par(mfrow = c(1,2))
plot.zresid(dev.LeukSurv.wbc,X="wbc",main.title = "Deviance Residual Plot of wbc Model",ylab="Deviance")
plot.zresid(dev.LeukSurv.logwbc,X="logwbc",main.title = "Deviance Residual Plot of lwbc Model",ylab="Deviance")
