...
### December 19, 2025
  ...
  In the vignettes, you can generate a large number like 1000 replicated Z-residuals so that the histograms look better, and the upper-bound p-values have more sample size.  
	   using the saved rds to save the pre-computed objects to inst/extdata to save the re-production time. See this: https://gemini.google.com/share/5362ba39f503 
...
The documents 
For your information, I used gemini to create this help for you to understand the two methods: 
