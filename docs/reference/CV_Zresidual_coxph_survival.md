...
fold, the Cox model is refitted on the training data, and the
Z-residuals are calculated on the held-out test data. This approach is
for models without shared frailty terms.
