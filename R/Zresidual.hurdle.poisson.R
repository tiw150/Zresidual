...
#'
#' @param fit A fitted \pkg{brms} model object for a hurdle or count Poisson outcome.
...
#'
#' @seealso
#' \code{\link{log.pred.dist.HP}}, \code{\link{log.pred.dist.TP}}, \code{\link{post_logrpp}}, \code{\link{iscv_logrpp}}
#' @export
Zresidual.hurdle.poisson <- function(fit,  type , method = "iscv", n.rep = 1){
