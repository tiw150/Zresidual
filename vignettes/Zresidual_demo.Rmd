...
You can install the development version of this package from [GitHub](https://github.com/tiw150/Zresidual) with: 
...
```{r fig.show="animate", animation.hook='gifski', interval=1, aniopts="controls,loop",cache= TRUE, fig.width=9, fig.height=4.5, echo=TRUE, results="hide",fig.align='center', fig.cap="Figure 1: QQ plots of Z-residuals for the wbc (left panels) and lwbc (right panels) models fitted to the survival data of acute myeloid leukemia patients"}
foreach (j = 1:nrep) %do%
  {
...
```{r fig.show="animate", animation.hook='gifski', interval=1, aniopts="controls,loop",cache= TRUE, fig.width=9, fig.height=9, echo=TRUE, results="hide",fig.align='center',fig.cap="Figure 2: Scatter plots and box plots of Z-residuals against LP for the wbc (left panels) and lwbc (right panels) models fitted to the survival data of acute myeloid leukemia patients"}
foreach (j = 1:nrep) %do%
  {
    par(mfrow = c(2, 2), mar = c(4, 4, 1.5, 2))
    plot.zresid(Zresid.LeukSurv.wbc,X="index", main.title = "Z-residual Scatterplot of wbc model",index=j)
    plot.zresid(Zresid.LeukSurv.logwbc,X="index", main.title = "Z-residual Scatterplot of lwbc model",index=j)
    
    boxplot.zresid(Zresid.LeukSurv.wbc, main.title = "Z-residual Boxplot of wbc model",index=j)
    boxplot.zresid(Zresid.LeukSurv.logwbc, main.title = "Z-residual Boxplot of lwbc model",index=j)
  }
...
```{r fig.show="animate", animation.hook='gifski', interval=1, aniopts="controls,loop",cache= TRUE, fig.width=9, fig.height=9, echo=TRUE, results="hide",fig.align='center', fig.cap="Figure 3: Scatter plots and box plots of Z-residuals against covariate (wbc) for the wbc (left panels) and lwbc (right panels) models fitted to the survival data of acute myeloid leukemia patients"}

foreach (j = 1:nrep) %do%
  {
    par(mfrow = c(2, 2), mar = c(4, 4, 1.5, 2))
    plot.zresid(Zresid.LeukSurv.wbc, X = "wbc", main.title = "Z-residual Scatterplot of wbc model",index=j)
    plot.zresid(Zresid.LeukSurv.logwbc,X = "logwbc",main.title = "Z-residual Scatterplot of lwbc model",index=j)
    
    boxplot.zresid(Zresid.LeukSurv.wbc, X = "wbc", main.title = "Z-residual Boxplot of wbc model",index=j)
    boxplot.zresid(Zresid.LeukSurv.logwbc, X = "logwbc",main.title = "Z-residual Boxplot of lwbc model",index=j)
