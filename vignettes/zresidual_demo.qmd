...
#| results: hide
#| fig-align: center
#| fig-cap: "Figure 4: Scatter plots and box plots of Z-residuals against covariate (sex) for the wbc (left panels) and lwbc (right panels) models fitted to the survival data of acute myeloid leukemia patients"
nrep=5
foreach (j = 1:nrep)  %do%  {
  par(mfrow = c(1, 2))
  boxplot.zresid(
