...
load("~/Desktop/Zresidual/vignettes/vignette_hurdle_supportive/fit_hnb.Rdata")
```
...
```{r eval=FALSE, message=FALSE, warning=FALSE, results='hide'}
zres_hp_post_zero <- Zresidual.hurdle.poisson(fit_hp, type = "zero", method = "post")
zres_hp_post_count <- Zresidual.hurdle.poisson(fit_hp, type = "count", method = "post")
zres_hp_post_hurdle <- Zresidual.hurdle.poisson(fit_hp, type = "hurdle", method = "post")
```
