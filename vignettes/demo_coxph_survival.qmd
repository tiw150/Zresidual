...
The table below summarizes ANOVA (Z-AOV) and Bartlett (Z-BL) test results for the first 10 repetitions.
...
### Histogram of Replicated P-values
...
### Comparison with Cox-Snell and Martingale Residuals
